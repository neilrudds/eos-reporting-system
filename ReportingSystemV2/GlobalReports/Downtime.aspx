<%@ Page Title="Global Downtime" Language="C#" MasterPageFile="~/GlobalReports/GlobalReports.Master" AutoEventWireup="true" CodeBehind="Downtime.aspx.cs" Inherits="ReportingSystemV2.GlobalReports.Downtime" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="GlobalReportingSubContent" runat="server">
    <div class="container-fluid">
        <asp:UpdatePanel ID="updDowntime" runat="server">
            <ContentTemplate>
                <%--Summary Table--%>
                ...
                <div id="detailDiv" runat="server">
                    <asp:GridView ID="gridDowntimeDetail" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    <asp:LinkButton ID="lnkBack" runat="server" Text="Back" CommandName="Back" OnClientClick="javascript:showMasterToolbar()"
                ...
                <div class="span7 text-center">
                    <div id="notesDiv" runat="server">
                        ...
                        <br />
                        <br />
                        <asp:LinkButton ID="lnkBack1" runat="server" OnClick="lnkBack_Click" OnClientClick="javascript:showMasterToolbar()">
    ...
    <script type="text/javascript">
        ...
        function hideMasterToolbar() {
            $('#MainContent_ToolbarPanel').hide();
        };

        function showMasterToolbar() {
            $('#MainContent_ToolbarPanel').show();
        };
