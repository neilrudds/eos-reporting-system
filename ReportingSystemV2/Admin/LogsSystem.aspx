<%@ Page Title="System Log" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="LogsSystem.aspx.cs" Inherits="ReportingSystemV2.Admin.LogsSystem" %>
<asp:Content ID="Content1" ContentPlaceHolderID="AdministrationSubContent" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanelGrid">
        <ContentTemplate>
            <div class="GridDock">
                <asp:GridView ID="GridSystemLog" runat="server" GridLines="None"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ActionPage" HeaderText="Page" />
